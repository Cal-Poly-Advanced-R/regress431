...
test_that("qr simple linear regression is correct", {

  my_result <- mtcars %>%
    simple_linear_regression(mpg, hp, method = "qr")
...
test_that("gradient descent simple linear regression is correct", {

  my_result <- mtcars %>%
    simple_linear_regression(mpg, hp, method = "gradientdescent")
...
test_that("qr multiple linear regression is correct", {

  my_result <- mtcars %>%
    dplyr::select(mpg, hp, cyl) %>%
    multiple_linear_regression(mpg, method = "qr")
...
test_that("gradient descent multiple linear regression is correct", {

  my_result <- mtcars %>%
    dplyr::select(mpg, hp, cyl) %>%
    multiple_linear_regression(mpg, method = "gradientdescent")
