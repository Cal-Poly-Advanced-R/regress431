...
In this lab, you will continue writing functions to implement simple linear regression,
...
* You **may** (probably should) write helper functions beyond those provided.  If you do, you do
...
all but your `ridge_regression.R` functions.
